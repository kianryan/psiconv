...
unsigned long uid2[32] = { /* bit 0  */  0x000076B4,
                           /* bit 1  */  0x0000ED68,
                           /* bit 2  */  0x0000CAF1,
                           /* bit 3  */  0x000085C3,
                           /* bit 4  */  0x000018A7,
...
unsigned long uid3[32] = { /* bit 0  */  0x00003331,
                           /* bit 1  */  0x00006662,
                           /* bit 2  */  0x0000CCC4,
                           /* bit 3  */  0x000089A9,
                           /* bit 4  */  0x00000373,
...
void printhex(unsigned long id)
{
  int i;
  for (i = 0; i < 8; i ++) {
    printhexdigit((id & 0xf0000000) >> 28);
    id = id << 4;
  }
}
...
{
  unsigned long res;
  res = checkuid(0x10000037,0x1000006D,0x1000007F);
  printhex(res);
  putchar('\n');
  exit(0);
}
